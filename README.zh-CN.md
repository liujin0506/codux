...
<p align="center">
  ...
  专为 <b>Claude Code</b>、<b>Codex</b>、<b>Gemini CLI</b>、<b>OpenCode</b> 打造。
</p>
...
| #   | 功能                  | 说明                                                                                                                                                                                                                                                             |
| :-- | :-------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **实时 AI 活动**      | 每个 AI 终端的实时运行状态 + 系统通知，支持 Claude Code、Codex、Gemini CLI、OpenCode。Tab 内指示器、项目卡片、系统通知会在每一回合结束时同时点亮 —— 你不再需要盯着光标发呆。                                                                                     |
