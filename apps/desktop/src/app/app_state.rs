...
pub struct CoduxApp {
    ...
    pub(in crate::app) cnb_sidebar_view: Option<gpui::Entity<sidebars::CnbSidebarView>>,
    pub(in crate::app) cnb_kind: CnbBrowseKind,
    pub(in crate::app) cnb_state_filter: String,
    pub(in crate::app) cnb_remote: Option<CnbBrowseRemote>,
    pub(in crate::app) cnb_items: Vec<CnbBrowseItem>,
    pub(in crate::app) cnb_detail: Option<CnbBrowseDetail>,
    pub(in crate::app) cnb_selected_id: Option<String>,
    pub(in crate::app) cnb_loading: bool,
    pub(in crate::app) cnb_detail_loading: bool,
    pub(in crate::app) cnb_error: Option<String>,
    pub(in crate::app) cnb_list_generation: u64,
    pub(in crate::app) cnb_comment_draft: String,
    pub(in crate::app) cnb_comment_revision: u64,
    pub(in crate::app) cnb_action_busy: bool,
