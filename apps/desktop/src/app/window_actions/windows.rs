...
impl CoduxApp {
    ...
    fn new_auxiliary_window_from_state(
        ...
        Self {
            ...
            cnb_sidebar_view: None,
            cnb_kind: CnbBrowseKind::Issues,
            cnb_state_filter: "open".to_string(),
            cnb_remote: None,
            cnb_items: Vec::new(),
            cnb_detail: None,
            cnb_selected_id: None,
            cnb_loading: false,
            cnb_detail_loading: false,
            cnb_error: None,
            cnb_list_generation: 0,
            cnb_comment_draft: String::new(),
            cnb_comment_revision: 0,
            cnb_action_busy: false,
