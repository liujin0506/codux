...
use codux_protocol::{
    ...
    REMOTE_CNB_INVOKE, REMOTE_CNB_INVOKE_RESULT, REMOTE_CNB_TOKENS_RESULT, REMOTE_CNB_TOKENS_SET,
    REMOTE_PAIRING_REJECTED, REMOTE_PAIRING_REQUEST,
    REMOTE_PROJECT_LIST, REMOTE_SSH_LIST,
...
impl RemoteController {
    ...
    pub fn cnb_tokens_set(&self, tokens: Value) -> Result<Value, String> {
        self.request(REMOTE_CNB_TOKENS_RESULT, REMOTE_CNB_TOKENS_SET, tokens)
    }

    pub fn cnb_invoke(&self, args: Value) -> Result<Value, String> {
        self.request(REMOTE_CNB_INVOKE_RESULT, REMOTE_CNB_INVOKE, args)
    }
